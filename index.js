...
module.exports = (api, options) => {
  api.registerCommand('start', {
    description: 'start development server compatible with webpack-bundle-tracker',
    usage: 'vue-cli-service start [options] [entry]',
    options: {
    ...
    return new Promise((resolve, reject) => {
      ...
      compiler.hooks.done.tap('vue-cli-service start', stats => {
        if (stats.hasErrors()) {
          return
        }
